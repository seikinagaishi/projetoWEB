		...
		<script type="text/javascript">	
			$(document).ready( 
				function() {
					...
					$("#content").load("view/listaTopicos.jsp?<%
						...
						if (idCategoria == null) {
							...
							if(category.next()) {
								out.write("idCategoria=" + idCategoria);
							}
							else {
								response.sendRedirect("categorias.html");
							}
						}
						...
						if (idUsuario == null && tipo == null ) {
							...
							if(user.next()) {
								out.write("idUser=" + idUsuario + "&tipo=" + tipo);
							}
							else {
								response.sendRedirect("profile.jsp?id=" + idUsuario);
							}
						}
					%>");
