...
<%
	...
	ResultSet comment = new Comentario().select("idUsuario='" + idUsuario + "' ORDER BY idComentario DESC");
%>
...
<div id="columns">
    <aside>
        ...
        <ul>
            ...
            <li class="lista">
                <a href="#" class="profile-option-selected">Comentários</a>
            </li>
            <li class="lista">
    ...
    <div id="side">
        <h2>Tópicos em que fez comentários</h2>
        ...
        <%
        	...
        	if(comment.next()) {
        		...
        		do {
        			index++;
        			ResultSet post = new Topico().select("idTopico='" + comment.getString("idTopico") + "'");
        			post.next();
        			
        			out.println("<li class='lista'>");
        			out.println("		<a href='topic.jsp?id=" + post.getString("idTopico") + "'>" + post.getString("titulo") + "</a>");
        			out.println("</li>");
        		} while(comment.next() && index < 9);
        		out.println("</ul>");
        		
        		if(index >= 9) {
        			out.println("<div id='discussion-btns'>");
        			out.println("	<a class='btns' href='listaTopicos.jsp?idUser=" + idUsuario + "&tipo=2'>");
        			out.println("		<div>Ver mais</div>");
        			out.println("</a></div>");
        		}
        	} else {
        		out.println("<li class='lista'>Nenhum comentário feito.</li>");
        	}
       	%>
