...
<%
	...
	ResultSet post = new Topico().select("idUsuario='" + idUsuario + "' ORDER BY idTopico DESC");
%>
...
<div id="columns">
    <aside>
        ...
        <ul>
            ...
            <li class="lista">
                <a href="#" class="profile-option-selected">Postagens</a>
            </li>
            <li class="lista">
       	...
       	<%
        	...
        	if(post.next()) {
        		...
        		do {
        			...
        			out.println("</li>");
        		} while(post.next() && index < 9);
        		out.println("</ul>");
        		
        		if(index >= 9) {
        			out.println("<div id='discussion-btns'>");
        			out.println("	<a class='btns' href='listaTopicos.jsp?idUser=" + idUsuario + "&tipo=1'>");
        			out.println("		<div>Ver mais</div>");
        			out.println("</a></div>");
        		}
        	} else {
        		out.println("<li class='lista'>Nenhum tópico criado.</li>");
        	}
       	%>
    </div>
</div>
