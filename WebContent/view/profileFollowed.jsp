...
<%
	...
	ResultSet f = new Seguir().select("idSeguido='" + idUsuario + "'");
%>
...
<div id="columns">
    <aside>
        ...
        <ul>
            ...
            <li class="lista">
                <a href="#" class="profile-option-selected">Seguidores</a>
            </li>
        </ul>
    </aside>
    ...
    <div id="side">
        ...
        <%
        	...
        	if(f.next()) {
        		...
        		do {
        			index++;
        			ResultSet seguindo = new Usuario().select("idUsuario='" + f.getString("idUsuario") + "'");
        			seguindo.next();
        			
        			out.println("<a class='owner-follow' href='profile.jsp?id=" + seguindo.getString("idUsuario") + "'>");
        			out.println("	<div class='owner-pic'> <img src='img/profile/" + seguindo.getString("foto") + ".jpg' class='foto'> </div>");
        			out.println("	<div class='owner-data'>");
        			out.println("		<div class='owner-name'>" + seguindo.getString("apelido") + "</div>");
        			out.println("</div></a>");
        		...
        		if(index >= 8) {
        			...
        			out.println("	<a class='btns' href='listaUsers.jsp?idUser=" + idUsuario + "&tipo=2'>");
        			out.println("		<div>Ver mais</div>");
        			out.println("</a></div>");
        		}
        	} else {
        		out.println("<li class='lista'>Ainda não está sendo seguido por ninguém.</li>");
        	}
       	%>
    </div>
</div>
